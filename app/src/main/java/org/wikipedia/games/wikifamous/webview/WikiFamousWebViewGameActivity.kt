...
class WikiFamousWebViewGameActivity : BaseActivity() {
    ...
    companion object {
        fun newIntent(context: Context, invokeSource: Constants.InvokeSource, wikiSite: WikiSite): Intent {
            return Intent(context, WikiFamousWebViewGameActivity::class.java)
                .putExtra(Constants.ARG_WIKISITE, wikiSite)
                .putExtra(Constants.INTENT_EXTRA_INVOKE_SOURCE, invokeSource)
                .putExtra(WikiFamousGameViewModel.EXTRA_GAME_ORDINAL, WikiGames.WIKI_FAMOUS_WEBVIEW.ordinal)
        }
    }
}
