...
class WordOfTheDayCard(
    ...
    override fun title(): String {
        return L10nUtil.getString(wikiSite().languageCode, R.string.view_word_of_the_day_card_title)
    }

    override fun type(): CardType {
        return CardType.WORD_OF_THE_DAY
    }

    override fun historyEntrySource(): Int {
        return HistoryEntry.SOURCE_FEED_WORD_OF_THE_DAY
    }
